...
namespace GameHelper.RemoteObjects.States.InGameStateObjects
{
    ...
    public class AreaInstance : RemoteObjectBase
    {
            ...
            : base(address)
        {
            ...
            {
                new("/LeagueAffliction/", 1145, 1145, this.AwakeEntities), // always keep this at index 0.
                new("Breach", 1135, 1139, this.AwakeEntities),
            };
        ...
        private void AddToCacheParallel(EntityNodeKey key, string path)
        {
            ...
            {
                if (Core.GHSettings.UsingUnendingNightmareDeliriumKeystone && i == 0)
                {
                    continue;
                }
